...
const GettingStarted = ({  }) => (
  <div className="fill getting-started">
    <div className="header">
        <a href="https://github.com/gregchamberlain/react-formulate" className="github-logo">
          <Github />
        </a>
    ...
    <div className="content">
      ...
      <Example data={str} output={true} readOnly/>
